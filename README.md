...
# ... (ggf. weitere Plattformen) ...
------------------------------
Wählen Sie GPU Index (0 bis N) [Enter für 0]: 1
...
# ... (Daten geladen) ...
[Main] Verarbeite kritische Klassenpaare für Loss Shaping... # << NEU
  Gefundenes Paar: ('.' -> ID 45, ' ' -> ID 0)             # << NEU
  Gefundenes Paar: ('\n' -> ID 10, ' ' -> ID 0)            # << NEU
[Main] Loss Shaping aktiviert für 2 Paare.                # << NEU
[Model Init] Erstelle Layer...
[Model Init] Erstelle Buffer...
[Model Init] Initialisierung abgeschlossen.
[Model] WARNUNG: Checkpoint-Datei nicht gefunden: ... Initialisiere Gewichte neu.
[EmbeddingLayer] Weights initialized (98x128)
[Main] Training startet bei Epoche 1, Schritt 1, LR 0.0001
[Main] Kritische Paar-Daten (16 bytes, 2 Paare) auf GPU geschrieben. # << NEU

========== Starte Trainings-Loop (50 Epochen, Start bei 1) ==========

--- Epoche 1/50 (LR: 0.0001) ---
  [Epoche 1, Batch 1000/9528] Loss: 2.485620 # << Kann Original oder Shaped sein, je nach Logging-Logik
  # ... (weitere Batch-Logs) ...
[Epoche 1] Durchschnittl. Train-Loss (Original): 2.489278
[Epoche 1] Durchschnittl. Train-Loss (Shaped) : 2.491123 # << NEU (Beispielwert)
[Epoche 1] Durchschnittl. Validierungs-Loss: 2.444133
[Epoche 1] Durchschnittl. Validierungs-Genauigkeit: 0.2811
